...
const features = [
  ...
  { icon: <Zap className="w-6 h-6" />, title: 'The fastest dictation on the market', desc: "Because the AI runs locally on your machine, there's zero upload delay and no server round-trip. Text appears in under a second — nothing else comes close." },
  { icon: <Shield className="w-6 h-6" />, title: 'Your voice never leaves your device', desc: "Audio is processed entirely on your machine. It's never uploaded, never stored, and never used to train AI models. Not ours. Not anyone's." },
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden bg-white">
        ...
        {/* Animated blobs */}
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-yellow-100 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-pulse" />
        <div className="absolute top-32 right-1/4 w-72 h-72 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse" style={{animationDelay: '1s'}} />

        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative">
          <div>
            <div
              className="inline-flex items-center gap-2 bg-gray-100 border border-gray-200 rounded-full px-4 py-1.5 mb-6"
            ...
            <p className="text-xs text-gray-400 mt-4" style={{ animation: 'fadeInUp 0.6s ease 0.4s both' }}>
              Free forever plan available · No credit card required
            </p>
          </div>

          <div className="float-animation" style={{ animation: 'fadeInUp 0.8s ease 0.2s both' }}>
            <HeroMockup />
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <Reveal key={step.num} delay={i * 120}>
                <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-gray-400 hover:shadow-md transition-all hover:-translate-y-1">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <Reveal key={f.title} delay={i * 80}>
                <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-gray-400 hover:shadow-md transition-all hover:-translate-y-1 group h-full">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Reveal delay={0}>
              <div className="bg-white border border-gray-200 rounded-2xl p-8 h-full">
                ...
                <Link to="/register" className="block text-center border border-gray-200 hover:border-gray-400 text-gray-700 px-6 py-3 rounded-xl font-medium transition-colors bg-white">
                  Get started free
                </Link>
              </div>
            </Reveal>
            ...
            <Reveal delay={120}>
              <div className="relative bg-gray-900 border border-gray-800 rounded-2xl p-8 h-full">
                ...
                <a href="https://buy.stripe.com/5kQ3cu8667oVeut3fvgQE09" className="block text-center bg-white hover:bg-gray-100 text-gray-900 px-6 py-3 rounded-xl font-semibold transition-all hover:scale-105">
                  Start Pro — $19/mo
                </a>
              </div>
            </Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <Reveal key={t.name} delay={i * 100}>
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 hover:shadow-md transition-all hover:-translate-y-1">
